...
describe('_resolveString test', () => {
  it('should resolve mapping inside mapping', () => {
    ...
    return expect(
      resolver._resolveString('{{array.{{index.value}}}}', data)
    ).toEqual('three');
  });
  ...
  it('should resolve mapping inside mapping with other content', () => {
    ...
    return expect(
      resolver._resolveString(
        'This is a string ' +
          '{{array.{{index.value}}}} that has a mapping in a mapping',
        data
      )
  ...
  it('should resolve multiple mapping inside mapping', () => {
    ...
    return expect(
      resovler._resolveString(
        'This is a string ' +
          '{{array.{{index.value}}}} that has a mapping in a mapping and {{array.{{index.value1}}}}',
        data
      )
  ...
  it('should resolve multiple mapping inside mapping inside mapping', () => {
    ...
    return expect(
      resolver._resolveString(
        'This is a string ' +
          '{{array.{{index.value}}.{{index.value1}}}} that has a mapping in a mapping',
        data
      )
    ).toEqual('This is a string three that has a mapping in a mapping');
  });
  ...
  it('should resolve multiple mapping inside mapping inside mapping', () => {
    ...
    return expect(
      resolver._resolveString(
        'This is a string ' +
          '{{array.{{index.{{property}}||number}}.{{index.value1}}||number}} that has a mapping in a mapping',
        data
      )
